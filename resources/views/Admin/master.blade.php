...
<head>
    ...
    <link href="{{asset('CoolAdmin-master/vendor/font-awesome-4.7/css/font-awesome.min.css')}}" rel="styleshe{asset('){()}}et" media="all">
    ...
    <link href="{{asset('CoolAdmin-master/vendor/select2/select2.min.cs')}}s" rel="stylesheet" media="all">
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="{{route('homeadmin')}}">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="{{route('homeadmin')}}">
